 ...
 * generated in the hu.jvrs.lion.wsimport package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetAfakulcsById_QNAME = new QName("http://beans.services.ws.lion.jvrs.hu/", "getAfakulcsById");
    private final static QName _GetAfakulcsKodEsById_QNAME = new QName("http://beans.services.ws.lion.jvrs.hu/", "getAfakulcsKodEsById");
    private final static QName _GetAfakulcsKodEsByIdResponse_QNAME = new QName("http://beans.services.ws.lion.jvrs.hu/", "getAfakulcsKodEsByIdResponse");
    private final static QName _SetCrud_QNAME = new QName("http://beans.services.ws.lion.jvrs.hu/", "setCrud");
    private final static QName _SetCrudResponse_QNAME = new QName("http://beans.services.ws.lion.jvrs.hu/", "setCrudResponse");
    private final static QName _GetAfakulcsByIdResponse_QNAME = new QName("http://beans.services.ws.lion.jvrs.hu/", "getAfakulcsByIdResponse");
    private final static QName _GetAllAfakulcsKodEsResponse_QNAME = new QName("http://beans.services.ws.lion.jvrs.hu/", "getAllAfakulcsKodEsResponse");
    private final static QName _GetAllAfakulcsKodEs_QNAME = new QName("http://beans.services.ws.lion.jvrs.hu/", "getAllAfakulcsKodEs");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: hu.jvrs.lion.wsimport
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://beans.services.ws.lion.jvrs.hu/", name = "getAfakulcsById")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://beans.services.ws.lion.jvrs.hu/", name = "getAfakulcsKodEsById")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://beans.services.ws.lion.jvrs.hu/", name = "getAfakulcsKodEsByIdResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://beans.services.ws.lion.jvrs.hu/", name = "setCrud")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://beans.services.ws.lion.jvrs.hu/", name = "setCrudResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://beans.services.ws.lion.jvrs.hu/", name = "getAfakulcsByIdResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://beans.services.ws.lion.jvrs.hu/", name = "getAllAfakulcsKodEsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://beans.services.ws.lion.jvrs.hu/", name = "getAllAfakulcsKodEs")
